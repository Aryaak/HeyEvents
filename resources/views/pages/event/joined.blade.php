...
<main class="py-16  max-w-screen-xl mx-auto px-4 md:px-6">
    <section class="flex items-center gap-x-10">
        <a href="{{route('event.joined')}}" class="{{$category == 'semua' ? 'link-secondary ' : 'text-grey cursor-pointer'}} ">Semua</a>
        <a href="{{route('event.joined', 'akan-berlangsung')}}" class="{{$category == 'akan-berlangsung' ? 'link-secondary ' : 'text-grey cursor-pointer'}}">Akan Berlangsung</a>
        <a href="{{route('event.joined', 'selesai')}}" class="{{$category == 'selesai' ? 'link-secondary ' : 'text-grey cursor-pointer'}}">Selesai</a>
    </section> 
