...
=======
                <div class="flex md:flex-row flex-col  items-center gap-x-8">
                    <a href="{{route('event.search')}}" class="btn-primary">Cari Events</a>
                    <a href="{{route('event.create')}}" class=" text-prime font-semibold">Buat Events</a>
>>>>>>> 9aae88da87b3cb5ce9b74cfea5c31d9ccadd26d1
                </div>
            </div>
        </section>
        ...
        <div
            ...
            <div class="flex justify-center">
                <h1 class="font-semibold md:text-3xl text-2xl md:ml-16 ml-0 mt-10 text-center">Cari dan <br
...
<<<<<<< HEAD
        <div class="bg-prime">
            <div class="flex flex-col mx-auto md:items-center md:justify-center md:flex-row md:px-8 lg:px-8 py-5 mt-16">
...
>>>>>>> 9aae88da87b3cb5ce9b74cfea5c31d9ccadd26d1
        ...
        <!-- card -->
        <div class="max-w-screen-xl mx-auto md:items-center md:justify-center md:flex-row md:px-8 lg:px-8 py-5 mt-16">
            ...
            <div class="flex md:flex-row flex-col justify-center">
                <div class="mx-4 mt-16 flex justify-center">
                    <div class="bg-white md:w-96 w-72 p-4 relative border-1 border-grey relative">
                        <div class="mb-5">
                            <!-- <img src="./img/smkn1-head.png" class="w-full"> -->
                        ...
                        <div class="mb-5 w-full">
                            <!-- <h4 class="text-prime font-bold text-xl w-full mb-2">SMK Coding Surabaya 2022</h4> -->
<<<<<<< HEAD
                            <p class="text-grey text-base md:w-full w-72 text-start">Webnya keren bangett. Belum ada konsep
                                aplikasi
                        ...
                        <div class="flex w-full">
                            <div>
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <div class="">
                                            <p class="text-prime font-bold w-full">
                                                SMKN 1 Surabaya</p>
                                            <img src="{{asset('img/check.svg')}}" class="w-1/4">
                                            {{-- <img src="{{asset('img/check.svg')}}" class="w-1/4 h-1/4"> --}}
                                        </div>
                                        {{-- <div class="relative top-5"> --}}
                                            {{-- <img src="{{ asset('img/check.svg') }}" class=""> --}}
                                        {{-- </div> --}}
                                        <p class="text-grey">Sekolah</p>
=======
                            <p class="text-grey text-base md:w-full w-72 text-left">Webnya keren bangett. Belum ada konsep
                                aplikasi
                                seperti ini di Indonesia, platform untuk cari info info event yang ada. Sangat
                                membantu buat orang kayak aku yang sukaa banget nge-event 😆</p>
                    </div>
                    <div class="flex">
                        <div>
                            <div class="flex">
                                <img src="{{asset('reviewer/1.png')}}" width="53" height="53">
                                <div class="ml-5">
                                    <div class="flex">
                                        <p class="text-prime font-bold">SMKN 1 Surabaya</p>
                                        <img src="{{asset('img/check.svg')}}" class="w-1/4 h-1/4">
