<main class="py-16  max-w-screen-xl mx-auto px-4 md:px-6">
    <div class="flex justify-between">
        <section class="flex items-center gap-x-10">
            ...
            <a class="text-grey cursor-pointer">Onsite</a>
            <a class="text-grey cursor-pointer">Online</a>
            <a class="text-grey cursor-pointer">Terverifikasi</a>
            <a class="text-grey cursor-pointer">Gratis</a>
            <a class="text-grey cursor-pointer">Berbayar</a>
        </section>
        <div>
            <div
    ...
    <section class="mt-16 grid grid-cols-3 gap-10">
        ...
        <div class="card">
            ...
            <a href="{{route('event.show', 'sss')}}" class="btn-event absolute right-0 bottom-0 py-4 group overflow-hidden">
