<main class="bg-background ">
                            ...
                            <div>
                                <div class="flex">
                                    ...
                                    <div class="ml-5">
                                        <div class="flex">
                                            <p class="text-prime font-bold">SMKN 1 Surabaya</p>
                                            <img src="img/ceklist.png" class="w-1/4 h-1/4">
                                        </div>
                                        <p class="text-grey">Sekolah</p>
                                    </div>
                                </div>
    ...
    <!-- footer -->
    <div class="mt-20 pb-8 text-grey text-center">
        <p>© 2022 HeyEvents! by Ampersand Team. All Rights Reserved.</p>
    </div>
</main>