    ...
    <main class="py-16  max-w-screen-xl mx-auto px-4 md:px-6">
        <section class="mx-auto flex md:justify-center gap-x-8 items-end relative">
            <img src="./img/4.jpg" width="110" height="110">
            <div>
                <h3 class="text-black font-bold md:text-3xl text-2xl">Jordan Frisay Himawan</h3>
                <p class="text-grey text-lg mt-2">Professional</p>
                <div class="flex justify-start mt-2">
                    <img src="./img/ic_location.svg" class="mr-3">
                    <p>Hiroshima</p>
                </div>
                <div class="flex absolute md:mt-3 mt-5 justify-self-center ">
                    <a href="edit_profile.html" class="btn-secondary mr-3">Edit Profil</a>
